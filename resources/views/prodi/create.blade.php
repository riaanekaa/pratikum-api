        ...
        <div class="card-body">
            ...
            @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="namaprodi" name="nama_prodi" placeholder="masukan nama prodi">
                </div>

                <div class="form-group">
                    <label for="kode_prodi">Kode Prodi</label>
                    <input type="text" class="form-control" id="kode_prodi" name="kode_prodi" placeholder="masukan kode prodi">
                </div>
