        ...
        <div class="card-body">
            ...
            @csrf
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="namadosen" name="nama_dosen" placeholder="masukan nama dosen">
                </div>

                <div class="form-group">
                    <label for="dosen_prodi">Dosen Prodi</label>
                    <input type="text" class="form-control" id="dosenprodi" name="dosen_prodi" placeholder="masukan dosen prodi mana??">
                </div>
